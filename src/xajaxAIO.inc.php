...
$__a = new xajaxFunctionPlugin();
$objPluginManager->registerPlugin($__a,100);
...
$__b = new xajaxEventPlugin();
$objPluginManager=&xajaxPluginManager::getInstance();$objPluginManager->registerPlugin($__b,103);
...
$__c = new xajaxIncludeClientScriptPlugin();
$objPluginManager=&xajaxPluginManager::getInstance();$objPluginManager->registerPlugin($__c,99);
...
$__e = new xajaxCallableObjectPlugin();
$objPluginManager=&xajaxPluginManager::getInstance();$objPluginManager->registerPlugin($__e,102);
...
$__d = new xajaxScriptPlugin();
$objPluginManager=&xajaxPluginManager::getInstance();$objPluginManager->registerPlugin($__d,9999);
